 ...
 */
public class GradientBoostingPredictionCombinerProcessor extends PredictionCombinerProcessor {
  ...
  public boolean process(ContentEvent event) {
    ...
    if (inEvent.isLastEvent() || hasAllVotesArrivedInstance(instanceIndex)) {
      ...
      ResultContentEvent outContentEvent = new ResultContentEvent(inEvent.getInstanceIndex(),
          inEvent.getInstance(), inEvent.getClassId(), combinedVote.getArrayCopy(), inEvent.isLastEvent());
